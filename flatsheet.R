...
locations <- subset(locations, select =c(OrgUnit5,Latitude,Longitude,OU3)) #get subet of location data
names(locations) <- c("OrgUnit05","lat","long","region")
...
#regionList<-unique(locations$OU3)
